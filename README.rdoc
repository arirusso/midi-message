...
* Flexible API to accommodate any kind of MIDI source
...
There are a few ways to create a new MIDI message.  Here are examples going from low to high-level
...
These examples and more explanation can be found {here}[http://github.com/arirusso/midi-message/tree/master/examples]  
