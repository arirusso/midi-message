...
Have a look at {unimidi}[http://github.com/arirusso/unimidi] (which I also wrote) if you want to send and receive these messages with your synths/sequencers/etc.
