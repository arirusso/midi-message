...
You can parse raw data
  ...
  MIDIMessage.parse(0xF0, 0x41, 0x10, 0x42, 0x12, 0x40, 0x00, 0x7F, 0x00, 0x41, 0xF7) # you could also use SystemExclusive.new here
...
The {examples}[http://github.com/arirusso/midi-message/tree/master/examples] have a more detailed explanation of all of this stuff
