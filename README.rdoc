...
== Usage
  ...
  # you can do the same for sysex messages:
...
see these and {more examples here}[https://github.com/arirusso/midi-message/tree/master/examples]
