...
A Node represents a device that you're sending a message to (eg. your {Yamaha DX7}[http://bit.ly/iH4TzL] is a Node).  Sysex messages can either be a Command or Request
