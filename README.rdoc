...
== Usage
  ...
  # instantiating sysex messages works similarly

  MIDIMessage.parse(0xF0, 0x41, 0x10, 0x42, 0x12, 0x40, 0x00, 0x7F, 0x00, 0x41, 0xF7)
  
  # or in a more object oriented way:
  
  # a Node represents a device that you're sending a message to (eg. your Yamaha DX7 is a Node)
  # sysex messages can either be a Command or Request
  # read more about this {here}[https://github.com/arirusso/midi-message/blob/master/examples/sysex.rb]
