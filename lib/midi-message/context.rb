...
module MIDIMessage
  ...
  class Context
    ...
    alias ProgramChange program_change
    ...
    alias ControlChange control_change
    alias Controller control_change
    alias controller control_change
    ...
    alias PolyphonicAftertouch polyphonic_aftertouch
    alias PolyAftertouch polyphonic_aftertouch
    alias PolyphonicPressure polyphonic_aftertouch
    alias PolyPressure polyphonic_aftertouch
    alias poly_aftertouch polyphonic_aftertouch
    alias poly_pressure polyphonic_aftertouch
    ...
    alias ChannelAftertouch channel_aftertouch
    alias ChannelPressure channel_aftertouch
    alias channel_pressure channel_aftertouch
