...
module MIDIMessage
  class SystemExclusiveTest < Minitest::Test
      ...
      context 'Builder' do
        context '.build' do
          context 'normal message' do
            setup do
              @message = MIDIMessage::SystemExclusive::Builder.build(0xF0, 0x41, 0x10, 0x42, 0x12, 0x40, 0x00, 0x7F,
                                                                     0x10, 0x41, 0xF7)
            end
          ...
          context 'weird message' do
            setup do
              @message = MIDIMessage::SystemExclusive::Builder.build(0xF0, 0x41, 0x12, 0x40, 0x00, 0x7F, 0x10, 0x41,
                                                                     0xF7)
            end
